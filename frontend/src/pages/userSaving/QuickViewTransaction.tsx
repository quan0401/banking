    ...
    <div>
      ...
      >
          ...
          <div className="ml-4 flex flex-col">
            <p className="font-bold text-lg flex items-center justify-between">
              {transaction.transactionType === 1 ? (
                <>
                  Top Up <FaCirclePlus className="text-green ml-2" />
                </>
              ) : (
                <>
                  Withdraw <FaCircleMinus className="text-rose-500 ml-2" />
                </>
              )}{" "}
            </p>
        ...
        <div className="flex items-center">
          <div>
            <p
              className={`font-bold text-lg flex items-center justify-end ${
                transaction.transactionType === 1
                  ? "text-green"
                  : "text-rose-500"
              }`}
