...
const UserSavingView: FC = (): ReactElement => {
  ...
  if (transactions && savingPlan) {
    compounds = calculateBaseOnTransactions(
      transactions.filter(
        (tran) =>
          tran.isSuccessful === 1 &&
          tran.transactionType === 1 &&
          tran.hasWithdrawn === false
      ),
      savingPlan
    );
  }
  ...
  }, [authUser?.id, savingPlanId, fetchNewData]);
        ...
        {!userSaving || !savingPlan || !transactions ? (
          ...
          <div>
                ...
                <>
                  <div className="rounded-lg">
                    ...
                    <ul className="mb-0 list-none">
                      ...
                      <li className="flex justify-between px-4 pb-4 pt-2 underline">
                        <div className="flex font-bold gap-2 text-md">
                          Current Profit
                        </div>
                        <span className="text-md font-bold">
            ...
            <SubPlanView
              ...
              savingPlan={savingPlan}
              setFetchNewData={() => setFetchNewData(!fetchNewData)}
            />
          </div>
        )}
      </>
