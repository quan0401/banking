import { IResetPassword } from "@interfaces/features/auth.interface";
...
const ResetPassword = () => {
  ...
  const onResetPassword = async (e: ChangeEvent) => {
    e.preventDefault();
    setIsLoading(true);
    // setStatus(AUTH_FETCH_STATUS.LOADING);
        ...
        <div className="relative px-5 py-5">
          ...
          <form className="mt-4 space-y-4 md:space-y-5 lg:mt-5">
            ...
            <Button
              ...
              label={`${
                isLoading ? "RESET PASSWORD IN PROGRESS..." : "RESET PASSWORD"
              }`}
